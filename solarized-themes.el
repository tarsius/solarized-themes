...
;;;;; font lock
     `(elisp-shorthand-font-lock-face ((,class (:slant italic))))
...
;;;;; ediff
     ;; `(ediff-current-diff-A        ((,c (:inherit magit-diff-our-highlight))))
     ;; `(ediff-current-diff-B        ((,c (:inherit magit-diff-their-highlight))))
     ;; `(ediff-current-diff-C        ((,c (:inherit magit-diff-base-highlight))))
     ;; `(ediff-current-diff-Ancestor ((,c (:inherit ediff-current-diff-C))))
     `(ediff-current-diff-A        ((,c (:extend t :background "#ffdddd"))))
     `(ediff-current-diff-B        ((,c (:extend t :background "#ddffdd"))))
     `(ediff-current-diff-C        ((,c (:extend t :background "#ffffcc"))))
     `(ediff-current-diff-Ancestor ((,c (:inherit ediff-current-diff-C))))
     `(ediff-fine-diff-A           ((,c (:inherit smerge-refined-removed))))
     `(ediff-fine-diff-B           ((,c (:inherit smerge-refined-added))))
     `(ediff-fine-diff-C           ((,c (:background "#ffdd22"))))
     `(ediff-fine-diff-Ancestor    ((,c (:inherit ediff-fine-diff-C))))
     `(ediff-even-diff-A           ((,c (:inherit magit-diff-our))))
     `(ediff-even-diff-B           ((,c (:inherit magit-diff-their))))
     `(ediff-even-diff-C           ((,c (:inherit magit-diff-base))))
     `(ediff-even-diff-Ancestor    ((,c (:inherit ediff-even-diff-C))))
     ...
     `(ediff-odd-diff-Ancestor     ((,c (:inherit ediff-odd-diff-C))))
;;;;; edts
